...
<main>
  ...
  <div class="dur-filter">
    <button class="dur-btn active" data-dur="all" onclick="filterDur(this)" data-i18n="dur_all">Tous</button>
    <button class="dur-btn" data-dur="short" onclick="filterDur(this)" data-i18n="dur_short">&lt; 5 min</button>
    <button class="dur-btn" data-dur="medium" onclick="filterDur(this)" data-i18n="dur_medium">5–20 min</button>
    <button class="dur-btn" data-dur="long" onclick="filterDur(this)" data-i18n="dur_long">&gt; 20 min</button>
  </div>
